...
<template>
  <main class="main">
    <img class="banner" src="@/assets/Attendee_survey2025.png" alt="COSCUP 2025 Developer Survey">
    <div
      v-if="!token && !loading"
      class="block"
    >
    ...
    >
      ...
      <div class="action">
        <!-- <a href="https://coscup.org/2025-survey/report" target="_blank"><BaseButton style="margin-top: 10px; width: 100%;text-align: center;" color="#25C2A5">{{ lang === 'zh' ? '查看調查結果' : 'View survey report' }}</BaseButton></a> -->
