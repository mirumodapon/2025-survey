...
<template>
  <main class="main">
    <img class="banner" src="@/assets/banner.jpg" alt="COSCUP 2023 Developer Survey">
    <div
      v-if="!token && !loading"
      class="block"
    >
    ...
    >
      ...
      <div class="action">
        <a href="https://coscup.org/2023-survey/report" target="_blank"><BaseButton style="margin-top: 10px; width: 100%;text-align: center;" color="#25C2A5">{{ lang === 'zh' ? '查看調查結果' : 'View survey report' }}</BaseButton></a>
