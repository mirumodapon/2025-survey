...
export const makeFormConfig: (t: (zh: string, en: string) => string, data: DataType) => FormConfig = (t, data) => {
  ...
  return [
    ...
    [
      ...
      { type: 'Field', key: 'is_take', question: '', config: { type: 'agree', question: t('是否願意填寫 COSCUP 2025 參與者大調查問卷？', 'Would you like to take the COSCUP 2025 attendee survey?') }, inline: true },
